...
{
       7,     0,    -1,    -1,     9,    -1,     9,     4,     8,    -1,
       8,     4,    10,    -1,    10,    -1,    10,    -1,    12,     5,
      11,    -1,    12,     5,    -1,    12,    -1,    12,     5,    11,
      -1,    12,    -1,     3,    -1
};
...
{
  "$end", "error", "$undefined", "STRING", "EOL", "WHITESPACE", "$accept",
  "grammar", "rules", "axiom", "rule", "symbols", "symbol", 0
};
#endif
...
{
      10,     1,    12,     6,     7,    13,    15,     8,    12,    14,
      16
};

static const yytype_uint8 yycheck[] =
{
       7,     3,     8,     0,     4,     4,    13,     5,    14,     5,
      14
};
...
#line 97 "desembigu.y"
    {
            cFS = string((yyvsp[(1) - (1)]));
            cSS.insert(cSS.begin(),string("ε"));
        ;}
    break;

  case 11:
#line 104 "desembigu.y"
    {
            cSS.insert(cSS.begin(),string((yyvsp[(1) - (3)])));
            // $$ = $1;
  ...
  case 12:
#line 109 "desembigu.y"
    {
           cSS.insert(cSS.begin(),string((yyvsp[(1) - (1)])));
            // $$ = $1;
